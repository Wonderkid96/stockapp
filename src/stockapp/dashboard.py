...
def update_signals(n):
    try:
        ...
        if response.status_code == 200:
            ...
            return [{"symbol": "Error", "timestamp": "N/A", "signal_type": "N/A", "reason": "Failed to fetch signals", "values": "N/A"}]
    except Exception as e:
        logger.error(f"Error updating signals: {e}")
        return [{"symbol": "Error", "timestamp": "N/A", "signal_type": "N/A", "reason": "Error updating signals", "values": "N/A"}]
